...
const ManageCars = () => {
  ...
  const confirmDeleteCar = async () => {
    try {
      console.log('Attempting to delete car with ID:', carToDelete.carId);
      
      await CarService.deleteCar(carToDelete.carId);
              ...
              <div className="modal-body py-4">
                ...
                {carToDelete && (
                  <p className="text-center fw-bold">
                    {carToDelete.brand} {carToDelete.carModel} ({carToDelete.plateNumber})
                  </p>
                )}
